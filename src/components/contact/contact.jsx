        ...
        <div className="flex mb-2">
          ...
          <div ref={LinkedinRef} className="flex w-full glassMorphism mx-3 px-3 rounded-md justify-between items-center">
            ...
            <div className="flex pt-1">
              ...
              <span className="iconBox" onClick={()=>{
                copyOperation("linkedin" , "www.linkedin.com/in/mehdirobatjazi")
              }}>
                <GoCopy />
              </span>
              <span className="iconBox">
                <a target="_blank" href="https://www.linkedin.com/in/mehdirobatjazi">
                  <HiOutlineEye  />
                </a>
              </span>
            </div>
        ...
        <div className="flex mb-2">
          ...
          <div ref={GithubRef} className="flex w-full glassMorphism mx-3 px-3 rounded-md justify-between items-center">
            ...
            <div className="flex  pt-1">
              ...
              <span className="iconBox" data-tooltip-target="copy-tooltip-box" onClick={()=>{
                copyOperation("github" , "https://github.com/mahdi-robatjazi78")
              }}>
                <GoCopy />
              </span>
         
              <span className="iconBox" data-tooltip-target="open-tooltip-box">
                <a target="_blank" href="https://github.com/mahdi-robatjazi78">
                  <HiOutlineEye />
                </a>
              </span>
