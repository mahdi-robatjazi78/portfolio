...
const NotashDetailModal = (props) => {
  ...
  const [selected, setSelected] = useState("rulechain");
                ...
                <div className="px-4 pb-4 pt-5 sm:p-6 sm:pb-4 ">
                  <div className="sm:flex sm:items-start">
                    <div className="mt-3 sm:ml-4 sm:mt-0">
                      ...
                      <div className="py-4">
                        <p className="text-sm selection-text-background text-gray-100 f-exo-medium">
                      ...
                      <Dialog.Title
                        as="h3"
                        className="selection-text-background text-base font-semibold leading-6 text-gray-100 f-exo-medium"
                      >
                      ...
                      <div className="w-full max-w-md px-0 md:px-2 py-6 sm:px-0">
                        <Tab.Group>
                          <Tab.List className="flex space-x-1 mb-3 rounded-xl bg-blue-900/20 p-1">
                            ...
                            <Tab
                              onClick={() => {
                                setSelected("ticketing");
                              }}
                              className={() =>
                                classNames(
                                  "f-exo-medium w-full rounded-lg py-2.5 text-sm font-medium leading-5",
                                  "ring-white/60 ring-offset-2 ring-offset-blue-400 focus:outline-none focus:ring-2",
                                  selected === "ticketing"
                                    ? "bg-white text-gray-950 shadow"
                                    : "text-blue-100 hover:bg-white/[0.12] hover:text-white"
